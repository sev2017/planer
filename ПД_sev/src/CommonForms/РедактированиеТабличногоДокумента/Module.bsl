...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Параметры.Свойство("РедактированиеСтарогоМакета", РедактированиеСтарогоМакета);
	Параметры.Свойство("ОбъектВладелец", ОбъектВладелец);
...
Процедура ЗагрузитьТабличныйДокументИзМетаданных()
	//Если ОбщегоНазначения.ПодсистемаСуществует("СтандартныеПодсистемы.Печать") Тогда
		...
		ТабличныйДокумент = УправлениеПечатью.МакетПечатнойФормы(Параметры.ИмяОбъектаМетаданныхМакета);
	//Ко//нецЕсли;
КонецПроцедуры
...
Процедура ЗаписатьТабличныйДокументИмяФайлаВыбрано(Знач ОбработчикЗавершения)
	...
	Если ЗначениеЗаполнено(ОбъектВладелец) Тогда		
		УправлениеПечатью.ЗаписатьМакет(ИмяДокумента, ПоместитьВоВременноеХранилище(ТабличныйДокумент), ОбъектВладелец, РедактированиеСтарогоМакета);
	КонецЕсли;
